...
<template>
  <footer :style="{ background: 'var(--bg-card)', borderTop: '1px solid var(--border)' }" class="py-12">
      ...
      <div class="flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        <div class="flex items-center gap-3">
          <a href="https://github.com" target="_blank" rel="noopener"
             ...
             :style="{ background: 'var(--bg-subtle)', color: 'var(--text-muted)' }" aria-label="GitHub">
          ...
          <a href="https://linkedin.com" target="_blank" rel="noopener"
             class="w-9 h-9 rounded-full flex items-center justify-center transition-all hover:scale-110"
             :style="{ background: 'var(--bg-subtle)', color: 'var(--text-muted)' }" aria-label="LinkedIn">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
